      ...
      <View className="flex-1 items-center ">
        ...
        >
          <View className="flex-row mt-1">
            <Text className="text-white text-3xl font-gordita-bold">MacGuffins</Text>
            <Text className="text-2xl text-white font-gordita-bold relative leading-none pt-2">®</Text>
